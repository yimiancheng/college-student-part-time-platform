        ...
        $('#table').bootstrapTable({
            ...
            columns: [
                        ...
                        validate: function (value) {
                            ...
                            if(pk) {
                                ...
                                if (rowData && rowData.orderLogs) {
                                    ...
                                    if(value == "订单完成" && oldValue != "订单发货") {
                                        return '商品未发货，不能修改为完成状态!';
                                    }

                                    if(oldValue == "订单发货" && value == "订单取消") {
                ...
                },
                {
                    ...
                    visible: true,
                    formatter: function (value, rowData, index) {
                        if (rowData && rowData.userVo) {
                            return rowData.userVo.usernick;
                        }
                    }
                },
                {
                ...
                },
                {
                    ...
                    formatter: function (value, rowData, index) {
                        if (rowData && rowData.userVo) {
                            return rowData.userVo.userContent;
                        }
                    }
                },
            ],
